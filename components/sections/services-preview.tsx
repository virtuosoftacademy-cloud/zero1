...
const services = [
  ...
  {
    title: "Distribution",
    description: "Scaling technology brands through strategic distribution networks.",
...
export function ServicesPreview() {
  ...
  <div key={index} className="flex items-center gap-5">
    <div className="relative w-[140px] h-[140px] shrink-0 overflow-hidden rounded-full">
      <Image
