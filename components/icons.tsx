...
export function UsersIcon({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M9 6a3 3 0 1 1 6 0 3 3 0 0 1-6 0zM17 6a2 2 0 1 1 4 0 2 2 0 0 1-4 0zM3 6a2 2 0 1 1 4 0 2 2 0 0 1-4 0zM3.5 18.5c0-3.5 2.5-5.5 5.5-5.5h6c3 0 5.5 2 5.5 5.5 0 1 0 1.5-1 1.5H4.5c-1 0-1-.5-1-1.5zM0 17c0-2 1.5-3 3-3h1.5c-.3.6-.5 1.3-.5 2v2H1c-1 0-1-.5-1-1zM20 16c0-.7-.2-1.4-.5-2H21c1.5 0 3 1 3 3 0 .5 0 1-1 1h-3v-2z" />
    </svg>
  );
}
...
/* Feature icons for About section */
...
export function BuildingIcon({ className = "h-6 w-6" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
